  ...
  <div class="p-5 space-y-6">
    ...
    <div class="space-y-3">
      ...
      <div class="space-y-3 rounded-xl p-4" :style="cellStyle">
        ...
        <div class="flex items-center justify-between py-1">
          <label class="text-[13px] font-medium" :style="{ color: themeColors.textMuted }">边框线型</label>
          <select :value="settings.cell_border_style"
            ...
            class="w-32 px-2.5 py-1.5 text-[13px] rounded-lg focus:outline-none focus:ring-2 transition-all"
            :style="{
              backgroundColor: settings.theme_mode === 'dark' ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.8)',
              border: '1px solid ' + themeColors.border,
              color: themeColors.text
        ...
        <div class="overflow-hidden transition-all duration-200"
          ...
          <div class="flex items-center justify-between py-1">
            <label class="text-[13px] font-medium" :style="{ color: themeColors.textMuted }">线型间隔</label>
            <div class="flex items-center gap-2">
    ...
    <div class="space-y-3">
      ...
      <div class="space-y-3 rounded-xl p-4" :style="cellStyle">
        <p class="text-[12px]" :style="{ color: themeColors.textMuted }">
          设置日程详情窗口的尺寸占比
        </p>

        <div class="flex items-center justify-between py-1">
          <label class="text-[13px] font-medium" :style="{ color: themeColors.textMuted }">窗口宽度占比</label>
          <div class="flex items-center gap-1">
            ...
            <span class="text-[12px] w-4 ml-1" :style="{ color: themeColors.textMuted }">%</span>
          </div>
        </div>

        <div class="flex items-center justify-between py-1">
          <label class="text-[13px] font-medium" :style="{ color: themeColors.textMuted }">窗口高度占比</label>
          <div class="flex items-center gap-1">
