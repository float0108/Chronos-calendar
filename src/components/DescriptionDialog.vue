...
const emit = defineEmits<{
  (e: 'save', scheduleId: number, description: string): void;
  (e: 'cancel'): void;
}>();
        ...
        <div class="bg-white/75 dark:bg-black/50 backdrop-blur-2xl w-full max-w-[320px] rounded-2xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.15)] border border-white/40 dark:border-white/10 overflow-hidden flex flex-col">
          ...
          <div class="px-5 flex-grow">
            <textarea
              ref="textareaRef"
              v-model="description"
              class="w-full min-h-[240px] py-3 text-[15px] bg-transparent border-none focus:ring-0 outline-none resize-none text-gray-800 dark:text-gray-100 placeholder:text-gray-400/60 leading-relaxed font-medium"
