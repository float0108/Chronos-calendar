...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::window::open_taskboard_window,
            commands::window::close_taskboard_window,
            commands::window::toggle_taskboard_window,
            commands::window::is_taskboard_window_visible,
